#!/bin/sh
# Generated by pipeline/generate.sh from pipeline/products/job-packets.sh.
...
exec python3 "$CELL_ROOT/ci_broker/client.py" run $flags --repo-root "$CELL_ROOT" --gate "job-packets" --lane "heavy" -- "$CELL_ROOT/pipeline/ci.sh" "job-packets" "$@"
