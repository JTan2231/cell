...
const INSTRUCTIONS: &str = "<bazaar:krisis.legacy.daily.instructions>";

const DEVELOPER_INSTRUCTIONS: &str = "<bazaar:krisis.legacy.daily.developer-instructions>";

const OBSERVATION_INSTRUCTIONS: &str = "<bazaar:krisis.legacy.account.instructions>";

const OBSERVATION_DEVELOPER_INSTRUCTIONS: &str =
    "<bazaar:krisis.legacy.account.developer-instructions>";
