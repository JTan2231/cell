...
candidate_template="$temporary_home/clockwork-candidate.template"
...
[ -L "$provider_selector" ]
[ -L "$current_selector" ]
[ "$("$command_selector" --version)" = "clockwork $package_version" ]
