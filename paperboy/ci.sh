#!/bin/sh
# Generated by pipeline/generate.sh from pipeline/products/paperboy.sh.
...
exec python3 "$CELL_ROOT/ci_broker/client.py" run $flags --repo-root "$CELL_ROOT" --gate "paperboy" --lane "heavy" -- "$CELL_ROOT/pipeline/ci.sh" "paperboy" "$@"
