...
fn normalized_promise() -> Value {
    json!({
        ...
        "completeness_and_freshness": [claim("declared", "The output includes every record in the selected page.")],
...
fn operation_entry() -> Value {
    json!({
        ...
        "support": "supported",
        "title": "Line up jobs",
        "summary": "Find and summarize job postings.",
        "use_when": ["A job shortlist is requested."],
        "do_not_use_when": ["An application submission is requested."],
        "outcome": "A conversational shortlist of job postings.",
        "effects": ["Reads selected postings."],
        "authority": ["The shortlist uses the selected posting text."],
        "success": ["Every shortlisted role includes its posting reference."],
        "failure_and_recovery": ["Report a failed posting read with its reference."],
        ...
        "automation": "none",
        "steps": ["Search job postings."],
        "checkpoints": ["Read the selected posting."],
        "adaptation": ["Reobserve current semantic controls."],
        "stop_when": ["Posting access is unavailable."],
