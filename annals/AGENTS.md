...
- This folder participates in the installed Semantics service. Its registered
  ...
  semantic history. Before you analyze, review, or change code, tests,
  ...
  `model_runner::Runner`, including in tests or future entry points. Do not add
  Semantics repository output or other repository-development instructions to
  a liaison's runtime prompt or context.
- There are no active users. Do not base design decisions on active-user needs
  or compatibility.
