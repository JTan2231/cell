...
pub const CELL_DIRECTION: &str = "bullet points for cell. Write a maximum of 3 concise resume bullet points. Keep each bullet short in form, with one brief sentence. Return only the bullet list.";
pub const WROUGHT_DIRECTION: &str = "bullet points for wrought. Write a maximum of 3 concise resume bullet points. Keep each bullet short in form, with one brief sentence. Return only the bullet list.";
