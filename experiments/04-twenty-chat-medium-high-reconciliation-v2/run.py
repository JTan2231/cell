...
def apply_pending(
    ...
    if applied is None or applied["id"] != state["id"] or applied["status"] != "applied":
...
def arm_summary(database: Path) -> dict[str, Any]:
    ...
    try:
        ...
        attempted_inspect_paths = 0
        successful_inspect_paths = 0
        ...
        return {
            ...
            "tools": {
                ...
                "attempted_inspect_paths": attempted_inspect_paths,
                "successful_inspect_paths": successful_inspect_paths,
            ...
            "reconciliations": {
                ...
                "annotations": sum(
                    len(r["annotations"]) for r in reconciliations
                ),
